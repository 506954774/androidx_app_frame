...
public class PermissionPageUtil {
    ...
    public static int REQUEST_PERMISSION_CODE = 303;
    ...
    //自己的项目包名
    private String packageName = AppLoader.getInstance().getPackageName();

    public PermissionPageUtil(Activity context) {
        this.mContext = context;
    }

    public void jumpPermissionPage(int code) {

        try{

            //赋值
            REQUEST_PERMISSION_CODE=code;
    ...
    private void goLGMainager(){
        try {
            ...
            mContext.startActivityForResult(intent,REQUEST_PERMISSION_CODE);
        } catch (Exception e) {
    ...
    private void goIntentSetting() {
        ...
        try {
            ...
            e.printStackTrace();
            Log.i("TAG","跳转默认设置页面失败:" + e.getMessage());
        }
    }
    ...
    private void goSysSetting(){
        ...
        //mContext.startActivityForResult(getSettingIntent(),REQUEST_PERMISSION_CODE);
