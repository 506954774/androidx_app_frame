...
public class Base64Utils {
   ...
   /* *//**
     ...
     * @return
     *//*
    public static String readBase64File(String filePath) throws Exception{
        String docUploadPath = "D:\\home\\gg.docx";
        File refereeFile = new File(docUploadPath);
        byte[] refereeFileOriginalBytes = fileToBytes(refereeFile);
    ...
    private byte[] fileToBytes(String path ) throws Exception{
        try {
