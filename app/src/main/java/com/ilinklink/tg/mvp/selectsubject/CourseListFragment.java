...
import com.ilinklink.tg.demo.list.CollectCourseAdapter;
...
public class CourseListFragment extends CustomBaseRefreshableFragment2{
    ...
    public BaseQuickAdapter2 initAdapter() {
        ...
        ExamAdapter collectCourseAdapter = new ExamAdapter(new ArrayList<ExamInfo>(), R.layout.item_ztsb_course, BR.ExamInfo);
