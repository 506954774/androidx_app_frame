...
package com.ilinklink.tg.mvp.shuanggang;
...
import com.spc.pose.demo.databinding.ActivityShuanggangbiqushenBinding;
...
@KeepName
public final class ShuanggangActivity extends BaseMvpActivity<ActivityShuanggangbiqushenBinding> implements View.OnClickListener  ,OnRequestPermissionsResultCallback, OnItemSelectedListener, CompoundButton.OnCheckedChangeListener {
    ...
    private String selectedModel = POSE_DETECTION_4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shuanggangbiqushen);
            ...
            public void call(Long aLong) {
                try {
                    ...
                    if(aLong >= 0 && aLong <=mTimer){
                        ...
                        /**取消此任务**/
                        RxHelper.getInstance(ShuanggangActivity.this).unsubscribe(mSubscriptionCount);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
