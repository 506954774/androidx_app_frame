...
public class WsFaceRecognizeActivity extends Activity implements CameraManager.CameraListener, View.OnClickListener {
...
//                        }
    ...
    private void initView() {
        ...
        setContentView(R.layout.activity_face_weishi);
        ...
        settingButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (durTime < CLICK_INTERVAL) {
                    ++mSecretNumber;
                    if (mSecretNumber == 5) {
                        Intent intent = new Intent(WsFaceRecognizeActivity.this, SettingActivity.class);
                        startActivity(intent);
                        WsFaceRecognizeActivity.this.finish();
                    }
                } else {
                    mSecretNumber = 0;
                }
    ...
    private void toast(String msg) {
        Toast.makeText(WsFaceRecognizeActivity.this, msg, Toast.LENGTH_SHORT).show();
    }
...
//            beginRecogIdArrayList.add(passImage.trackId);
            ...
            try {
                sbody = new StringBody(WsFaceRecognizeActivity.group_name, ContentType.TEXT_PLAIN.withCharset(CharsetUtils.get("UTF-8")));
            } catch (UnsupportedEncodingException e) {
                e.printStackTrace();
            }
