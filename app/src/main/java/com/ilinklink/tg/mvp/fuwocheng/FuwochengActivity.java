...
package com.ilinklink.tg.mvp.fuwocheng;
...
@KeepName
public final class FuwochengActivity extends BaseMvpActivity<ActivityFuwochengBinding> implements View.OnClickListener  ,OnRequestPermissionsResultCallback, OnItemSelectedListener, CompoundButton.OnCheckedChangeListener {
    ...
    private String selectedModel = POSE_DETECTION_2;
     ...
     * 测试重复初始化poseSDK
     */
    private void  testRebuildPoseSDK(){
        mViewBind.tvSubjectName.postDelayed(new Runnable() {
            @Override
            public void run() {
              /*  ToastUtil.showCustomMessageShort(FuwochengActivity.this,"createCameraSource(selectedModel)");
                createCameraSource(selectedModel);

                testRebuildPoseSDK();*/


                Intent intent = new Intent(FuwochengActivity.this, ExamSettingActivity.class);
                intent.putExtra(ExamSettingActivity.INTENT_EXAM_SUBJECT_NAME,"俯卧撑");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode==110){
            if(resultCode==RESULT_OK){
                ...
                ExamSettingUtils.setExamSetting(this, "俯卧撑",stringExtra);
            }
        }
            ...
            public void call(Long aLong) {
                try {
                    ...
                    if(aLong >= 0 && aLong <=mTimer){
                        ...
                        /**取消此任务**/
                        RxHelper.getInstance(FuwochengActivity.this).unsubscribe(mSubscriptionCount);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
