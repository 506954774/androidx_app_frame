...
public class InitFaceFeatrueAct2 extends Activity implements CameraManager.CameraListener, View.OnClickListener {
            ...
            public void run() {
                ...
                if(isSuccess){
                    ...
                    for (int i = 0; i < imagesPaths.length; i++) {
                        ...
                        StudentInfo old = DBHelper.getInstance(InitFaceFeatrueAct2.this).getStudentInfo(imagesPaths[i]);
                        if(old!=null){
                            if(old.getDesc()!=null){
                                ...
                                if (result.result == 0) {
                                    ...
                                    try {
                                        ...
                                        if(b){
                                            ...
                                            DBHelper.getInstance(InitFaceFeatrueAct2.this).saveStudentInfo(student);
                                        }
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            startActivity(new Intent(InitFaceFeatrueAct2.this, SelectSubjectActivity.class));
                            finish();
                        }
                    });
                    ...
                    if (detectionResult != null && detectionResult.message.length != 0) {
                        ...
                        for (int i = 0; i < detectionResult.images.length; ++i) {
                            if (detectionResult.images[i].rcAttr.respiratorType != FacePassRCAttribute.FacePassRespiratorType.INVALID
                                ...
                                trackOpts[i] = new FacePassTrackOptions(detectionResult.images[i].trackId, searchThreshold, livenessThreshold, smallsearchThreshold);
                            }
...
//                        }
    ...
    private void initView() {
        ...
        setContentView(R.layout.activity_main_weishi);
        ...
        settingButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (durTime < CLICK_INTERVAL) {
                    ++mSecretNumber;
                    if (mSecretNumber == 5) {
                        Intent intent = new Intent(InitFaceFeatrueAct2.this, SettingActivity.class);
                        startActivity(intent);
                        InitFaceFeatrueAct2.this.finish();
                    }
                } else {
                    mSecretNumber = 0;
                }
    ...
    private void toast(String msg) {
        Toast.makeText(InitFaceFeatrueAct2.this, msg, Toast.LENGTH_SHORT).show();
    }
...
//            beginRecogIdArrayList.add(passImage.trackId);
            ...
            try {
                sbody = new StringBody(InitFaceFeatrueAct2.group_name, ContentType.TEXT_PLAIN.withCharset(CharsetUtils.get("UTF-8")));
            } catch (UnsupportedEncodingException e) {
                e.printStackTrace();
            }
