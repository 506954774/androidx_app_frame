...
public class CustomClickTextView extends TextView {



    private static final String TAG = "CustomClickTextView";
    ...
    public CustomClickTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mResources = getResources();
    ...
    public CustomClickTextView(Context context, AttributeSet attrs, int defStyleAttr) {
