...
public class CustomClickBtn extends Button {



    private static final String TAG = "CustomClickBtn";
    ...
    public CustomClickBtn(Context context) {
        super(context);
        mResources = getResources();
    }

    public CustomClickBtn(Context context, AttributeSet attrs) {
        super(context, attrs);
        mResources = getResources();
    ...
    public CustomClickBtn(Context context, AttributeSet attrs, int defStyleAttr) {
