...
public class CustomBottomBar extends RelativeLayout implements RadioGroup.OnCheckedChangeListener{
    ...
    private void initView() {
        ...
        mRadioBtns[1]=(BGABadgeRadioButton) findViewById(R.id.rb_fragment_mine);
        mRadioBtns[2]=(BGABadgeRadioButton) findViewById(R.id.rb_fragment_set);
