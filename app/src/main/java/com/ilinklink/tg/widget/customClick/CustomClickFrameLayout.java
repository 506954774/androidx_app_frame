...
public class CustomClickFrameLayout extends FrameLayout {



    private static final String TAG = "CustomClickLinearLayout";
    ...
    public CustomClickFrameLayout(Context context) {
        super(context);
        mResources = getResources();
    }

    public CustomClickFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        mResources = getResources();
    ...
    public CustomClickFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
