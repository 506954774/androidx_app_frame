...
public class Utils {
    ...
    static int[] COLORS = {Color.parseColor("#FFD15D"), Color.parseColor("#FC7EBC"), Color.parseColor("#9671F5"), Color.parseColor("#9671F5")};

    public static int getScoreColor(float score) {
        if(score<30){
            return COLORS[0];
        }
        else if(score<60){
