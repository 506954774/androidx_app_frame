...
package com.spc.pose.demo.preference.graphic;
...
import com.spc.posesdk.GraphicOverlay.Graphic;
...
public class PoseGraphic extends Graphic {
  ...
  private void maybeUpdatePaintColor(Paint paint, Canvas canvas, float zInImagePixel) {
    ...
    if (rescaleZForVisualization) {
      ...
      // By default, assume the range of z values in screen pixel is [-canvasWidth, canvasWidth].
    ...
    if (zInScreenPixel < 0) {
      ...
      // color. The larger the values is, the more red it will be.
      ...
      // color. The larger the values is, the more blue it will be.
