...
public class PopWindowChooseSingleColumn extends PopupWindow implements View.OnClickListener{
    ...
    LinearLayout ll;//父容器
    View view=null;
    private int mSelectedIndex;//选中的item的索引

    private String mTitle;
    private String [] mData;


    public PopWindowChooseSingleColumn(Context context,String mTitle, String [] mData,GenderChoseFinishedListener finishedListner) {
        super(context);
    ...
    public void onClick(View v) {
        ...
        if(id==R.id.btn_cancel){
            ...
            if(finishedListner!=null){//非空验证
                finishedListner.handleChoose(mSelectedIndex);
            }
            this.dismiss();
        }
    ...
    OnWheelScrollListener scrollListener = new OnWheelScrollListener() {
        ...
        public void onScrollingFinished(WheelView wheel) {
            ...
            try {
               mSelectedIndex =genderView.getCurrentItem();
            } catch (Exception e) {
