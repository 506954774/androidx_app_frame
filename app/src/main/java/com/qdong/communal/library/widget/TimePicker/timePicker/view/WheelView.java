...
/*
	private int[] SHADOWS_COLORS = new int[] { 0x90E9E9E9,
			0x30E9E9E9, 0x00E9E9E9 };
*/
/*	private int[] SHADOWS_COLORS = new int[] {0xFF585858,
	...
	WheelScroller.ScrollingListener scrollingListener = new WheelScroller.ScrollingListener() {
		...
		public void onStarted() {
			...
			//新增回调,修改字色
			viewAdapter.onScollStarted(mViewMaps,getCurrentItem());
		}
		...
		public void onScroll(int distance) {
			...
			//新增回调,修改字色
			viewAdapter.onScroll(mViewMaps,getCurrentItem());
		}
		...
		public void onFinished() {
			...
			//新增回调,修改字色
			viewAdapter.onScollEnd(mViewMaps,getCurrentItem());
	...
	private HashMap<Integer,View> mViewMaps=new HashMap<Integer,View>();
