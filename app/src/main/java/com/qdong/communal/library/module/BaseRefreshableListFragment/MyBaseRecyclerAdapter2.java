 ...
 **/
public abstract class MyBaseRecyclerAdapter2<VH extends RecyclerView.ViewHolder, D> extends RecyclerView.Adapter {
    ...
    public MyBaseRecyclerAdapter2(List<D> mData, Context context) {
