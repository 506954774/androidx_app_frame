...
public class PagerTab extends ViewGroup {
    ...
    private void init(TypedArray mTypedArray) {
        ...
        //分割线颜色
        mDividerColor = mTypedArray.getColor(R.styleable.PagerTab_dividerColor, Color.parseColor("#dadada"));
        //指示器的高度
    ...
    private void addTab(final int position, View tab) {
        ...
        //tab.setPadding(mTabPadding, mTabPadding, mTabPadding, mTabPadding);
