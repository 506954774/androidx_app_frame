 ...
 */
public abstract class BaseQuickAdapter2<T, K extends BaseViewHolder2> extends RecyclerView.Adapter<K> {

    //load more
    private boolean mNextLoadEnable = false;
    private boolean mLoadMoreEnable = false;
    private boolean mLoading = false;
    private LoadMoreView2 mLoadMoreView = new SimpleLoadMoreView2();
    ...
    protected static final String TAG = BaseQuickAdapter2.class.getSimpleName();
     ...
     * @param loadingView
     */
    public void setLoadMoreView(LoadMoreView2 loadingView) {
     ...
     */
    public BaseQuickAdapter2(@LayoutRes int layoutResId, @Nullable List<T> data) {
    ...
    public BaseQuickAdapter2(@Nullable List<T> data) {
        this(0, data);
    }

    public BaseQuickAdapter2(@LayoutRes int layoutResId) {
    ...
    public K onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case LOADING_VIEW:
                ...
                break;
            case HEADER_VIEW:
                baseViewHolder = createBaseViewHolder2(mHeaderLayout);
                break;
            case EMPTY_VIEW:
                baseViewHolder = createBaseViewHolder2(mEmptyLayout);
                break;
            case FOOTER_VIEW:
                baseViewHolder = createBaseViewHolder2(mFooterLayout);
                break;
            default:
    ...
    private K getLoadingView(ViewGroup parent) {
        ...
        K holder = createBaseViewHolder2(view);
    ...
    public void onBindViewHolder(K holder, int positions) {
        ...
        switch (viewType) {
            case 0:
                ...
                break;
            case LOADING_VIEW:
                mLoadMoreView.convert(holder, positions);
                break;
            case HEADER_VIEW:
                break;
            case EMPTY_VIEW:
    ...
    private void bindViewClickListener(final BaseViewHolder2 baseViewHolder) {
        ...
        if (getOnItemClickListener() != null) {
            view.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    getOnItemClickListener().onItemClick(BaseQuickAdapter2.this, v, baseViewHolder.getLayoutPosition() - getHeaderLayoutCount());
                }
            });
        }
        if (getOnItemLongClickListener() != null) {
            view.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    return getOnItemLongClickListener().onItemLongClick(BaseQuickAdapter2.this, v, baseViewHolder.getLayoutPosition() - getHeaderLayoutCount());
                }
            });
        }
    }
    ...
    protected K onCreateDefViewHolder(ViewGroup parent, int viewType) {
        ...
        return createBaseViewHolder2(parent, layoutId);
    }

    protected K createBaseViewHolder2(ViewGroup parent, int layoutResId) {
        return createBaseViewHolder2(getItemView(layoutResId, parent));
    }

    /**
     * if you want to use subclass of BaseViewHolder2 in the adapter,
    ...
    protected K createBaseViewHolder2(View view) {
        Class temp = getClass();
        Class z = null;
        ...
        return null != k ? k : (K) new BaseViewHolder2(view);
    }
        ...
        if (type instanceof ParameterizedType) {
            ...
            for (Type temp : types) {
                if (temp instanceof Class) {
                    ...
                    if (BaseViewHolder2.class.isAssignableFrom(tempClass)) {
                        return tempClass;
                    }
                }
            }
    ...
    /**
     * When the current adapter is empty, the BaseQuickAdapter2 can display a special view
    ...
    public View getViewByPosition(RecyclerView recyclerView, int position, @IdRes int viewId) {
        ...
        BaseViewHolder2 viewHolder = (BaseViewHolder2) recyclerView.findViewHolderForLayoutPosition(position);
        if (viewHolder == null) {
            return null;
        }
        return viewHolder.getView(viewId,position);
    }
    ...
    public interface OnItemChildClickListener {
         ...
         */
        void onItemChildClick(BaseQuickAdapter2 adapter, View view, int position);
    }
    ...
    public interface OnItemChildLongClickListener {
         ...
         */
        boolean onItemChildLongClick(BaseQuickAdapter2 adapter, View view, int position);
    }
    ...
    public interface OnItemLongClickListener {
         ...
         * @return true if the callback consumed the long click ,false otherwise
         */
        boolean onItemLongClick(BaseQuickAdapter2 adapter, View view, int position);
    }
    ...
    public interface OnItemClickListener {
         ...
         */
        void onItemClick(BaseQuickAdapter2 adapter, View view, int position);
    }
