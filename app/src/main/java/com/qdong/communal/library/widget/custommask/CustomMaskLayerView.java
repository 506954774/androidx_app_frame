...
public class CustomMaskLayerView extends RelativeLayout {
    ...
    private TextView mTextViewRetry1;//再试一次提示
    ...
    protected void initView() {
        ...
        mTextViewRetry1= (TextView) findViewById(R.id.tv_reload_1);
        mTextViewRetry1.getPaint().setFlags(Paint.UNDERLINE_TEXT_FLAG | Paint.ANTI_ALIAS_FLAG);

        mTextViewRetry1.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mReloadCallback != null) {
                    mReloadCallback.reload();
