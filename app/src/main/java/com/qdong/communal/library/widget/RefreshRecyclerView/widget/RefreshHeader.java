...
public class RefreshHeader extends FrameLayout implements PtrUIHandler {
    ...
    private PtrUIHandler mPtrUIHandler;//额外的操作接口


    public void setmPtrUIHandler(PtrUIHandler mPtrUIHandler) {
        this.mPtrUIHandler = mPtrUIHandler;
    }
